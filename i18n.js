...
const i18n = {
    ...
    translations: {
        en: {
            ...
            'toolbar.title': '<img src="icons/lightning.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[fast]"> TypeLess - Auto Form Filler',
            ...
            'notify.imported': '📥 Import done:<br>+{added} added<br>↺{updated} updated<br>⚠️{skipped} skipped',
            ...
            'overwrite.title': '<img src="icons/warning.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[!]"> Profile "{name}" already exists for this page!',
            ...
            'popup.restricted_msg': 'TypeLess cannot work on system browser pages. Please switch to a regular webpage.',
            'popup.restricted_msg_protocol': 'TypeLess cannot work on {protocol} pages (system browser page). Please switch to a regular webpage.',
            'popup.restricted_unavailable': 'Not available on system pages',
            ...
            'footer.buy': 'Buy me a <img src="icons/beer.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[beer]">',
            ...
            'menu.smart_fill': '<img src="icons/lightning.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[fast]"> Smart Fill Form',
            'menu.save_profile': 'Save Form as Profile',
            'menu.remove_readonly': '<img src="icons/unlock.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[unlock]"> Remove Readonly & Disabled',
            ...
            'privacy.last_updated_date': 'March 1, 2026',
            ...
            'privacy.perm_webnav_purpose': 'Detect URL changes in Single-Page Apps (SPA) to automatically refresh the profile list',
            'privacy.perm_webnav_privacy': 'Only listens to internal browser navigation events; no browsing history or page data is collected.',
            ...
            'options.btn_edit': 'Edit',
            'options.delete_all': 'Delete All',
            'options.confirm_delete_all': 'Delete ALL profiles? This cannot be undone.',
            'options.refresh_list': 'Refresh List',
            'options.drag_to_reorder': 'Drag to reorder',
            // Intro / landing page
            'intro.title': 'TypeLess – Auto Form Filler',
            'intro.desc': 'Save web form data as profiles and auto-fill them with one click. Supports Smart Fill for common fields (name, email, phone, address), full-page screenshot, User-Agent switching, and more. All data stored <strong>100% locally</strong> — nothing ever leaves your device.',
            'intro.available_on': 'Available on',
            'intro.badge_local': '<img src="icons/lock.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[lock]"> 100% Local',
            'intro.badge_free': '<img src="icons/free-badge.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[free]"> Free',
            'intro.badge_noad': '<img src="icons/no-ads.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[no]"> No Ads',
            'intro.badge_multilang': '<img src="icons/world.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[globe]"> 6 Languages',
            'store.chrome': 'Chrome Web Store',
            'store.edge': 'Microsoft Edge',
            'chip.toolbar': '<img src="icons/monitor.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[screen]"> Toolbar',
            'chip.focus_field': '<img src="icons/target.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[target]"> Focus Field',
            'chip.ua': '<img src="icons/mobile.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[mobile]"> User-Agent',
            'callout.save': 'Save',
            'callout.smartfill': 'Smart Fill',
            'callout.profilelist': 'Profile list',
            'shortcut.enter_addfld': 'Enter (in Add Field)',
            'error.common': 'Error: ',
            'options.profile_delete_failed': 'Failed to delete profile.',
            'options.profile_save_failed': 'Failed to save profile.',
            // Guide image alt texts
            'guide.alt_modal_focus_btn': 'Focus button in modal',
            'guide.alt_modal_save_profile': 'Save profile modal',
            'guide.alt_notify_applied': 'Applied notification',
            'guide.alt_profile_editor': 'Profile editor',
            'guide.alt_profiles_list': 'Profiles list',
            'guide.alt_smartfill_result': 'Smart Fill result',
            'guide.alt_toolbar_apply_profile': 'Toolbar apply profile',
            'guide.alt_toolbar_overview': 'Toolbar overview',
            'guide.alt_toolbar_save_btn': 'Toolbar save button',
            'guide.alt_toolbar_smart_fill': 'Toolbar Smart Fill',
            'options.add_field_label': '+ Add Field:',
            ...
            // ── Guide / Welcome page ────────────────────────────────────────
            'guide.s1_title': '<img src="icons/monitor.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[screen]"> Toolbar',
            ...
            'guide.s2_title': '<img src="icons/save.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[save]"> Save Profile',
            ...
            'guide.s2_focus_title': '<img src="icons/target.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[target]"> Choose Focus Field (optional)',
            'guide.s2_focus_caption': '<img src="icons/target.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[target]"> column — click to select the field focused after apply',
            'guide.s2_focus_desc': 'Click the <strong><img src="icons/target.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[target]"></strong> button at the end of a row to mark that field for <strong>auto-focus</strong> (cursor jumps there) right after applying the profile. Handy for continuing to type after auto-fill.',
            'guide.s3_title': '<img src="icons/play-arrow.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[play]"> Apply Profile',
            ...
            'guide.s4_title': '<img src="icons/lightning.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[fast]"> Smart Fill',
            ...
            'guide.s4_col1_label': 'Click <img src="icons/lightning.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[fast]"> on the toolbar',
            ...
            'guide.s5_title': '<img src="icons/folder-tab.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[folder]"> Advanced Profile Management',
            ...
            'guide.s6_title': '<img src="icons/keyboard.svg" style="width:1em;height:1em;vertical-align:-0.15em;display:inline-block;" alt="[keyboard]"> Shortcuts & Tips',
